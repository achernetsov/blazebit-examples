...
POST http://localhost:8080/items/init

3. Check Items available

GET http://localhost:8080/items

4. Check blaze-persistence CTE:

GET http://localhost:8080/items/cteGroups
...
You can then execute your native executable with: `./build/blazebit-examples-1.0-SNAPSHOT-runner`
